...
{ 
    ...
    @catch (NSException *exception) {
        ALERT(APP_NAME, @"Error Occured! Please check internet connection.");
    }     
    return dicResult;    
}
...
+(void) urlStringInBG:(NSString*)strUrl progressView:(UIView*)view completionHandler:(void (^)(NSDictionary*))callbackBlock
{
    WebServices *webServoceObj = [[WebServices alloc] init];    
    [webServoceObj showProgressBar:view];
